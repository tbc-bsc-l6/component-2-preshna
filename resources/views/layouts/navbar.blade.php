<div class="bg-gray-700 px-4 sm:px-6 py-3 flex items-center justify-between shadow h-16 fixed top-0 left-0 right-0 z-50">
    <div class="flex items-center text-white">
        <svg class="h-6 w-6 mr-2 fill-current text-gray-500" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 640 512">
    ...
    <div class="relative">
        @auth
            ...
            <div class="bg-gray-700 absolute top-0 right-0 mt-12 -mr-6 shadow rounded-bl rounded-br">
